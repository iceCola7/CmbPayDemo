...
public class CmbSignReqData {
    ...
    public CmbSignReqData(String dateTime, String merchantSerialNo, String agrNo, String branchNo, String merchantNo, String noticeUrl, String returnUrl, String noticePara) {
